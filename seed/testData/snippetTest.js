const snippet1 = {
  ...
  `,
  aboutPre: `THIS IS SAMPLE TEXT:: This component will re-render whenever the user moves the mouse. This can be dozens and dozens of times a second.
  ...
  aboutPost: 'THIS SHOULD BE DISPLAYED AFTER THE SNIPPET'
}
